...
//
//        StackedPolytope sP = new StackedPolytopeImpl(new PointInteger(
...
//                        "1"), new BigInteger("4"), new BigInteger("0")));
//        sP.divide(new PointInteger(new BigInteger("1"), new BigInteger("2"),
//                new BigInteger("1")));
//
...
//    }
    ...
    public static void showPolytope(StackedPolytope sP) {
        ...
        for (int i = 0; i < faceIndices.size(); i++) {
            faceIndices1.add(Transformation.arrayListToArray(
                    faceIndices.get(i), true));
        }
        ...
        // sP1.smallerPolytopes()[0].getPoints()[0]);
    }
