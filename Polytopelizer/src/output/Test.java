...
public class Test {
    ...
    public static void main(String[] args){
        ApollonianNetwork aN = new ApollNetwork(new Point2D(0,0), new Point2D(10,0), new Point2D(0,10));
        aN.addNode(2, 2);
    ...
    private static void iteratePolytope(StackedPolytope sP, ArrayList<ArrayList<Double>> al, ArrayList<ArrayList<Integer>> al2){
